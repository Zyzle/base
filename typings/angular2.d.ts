// Type definitions for Angular v2.0.0-local+sha.7b2f757
...
declare module "angular2/angular2" {
  ...
  /**
   * Map from <a href='/angular2/change_detection/ChangeDetectorDefinition#id'><code>ChangeDetectorDefinition</code></a> to a factory method which takes a
   * <a href='/angular2/angular2/PipeRegistry'><code>PipeRegistry</code></a> and a <a href='/angular2/change_detection/ChangeDetectorDefinition'><code>ChangeDetectorDefinition</code></a> and generates a
   * <a href='/angular2/change_detection/ProtoChangeDetector'><code>ProtoChangeDetector</code></a> associated with the definition.
   */
  ...
  class Injector {
     ...
     * bindings into a list of <a href='/angular2/di/ResolvedBinding'><code>ResolvedBinding</code></a>s. The resolution can be cached by `resolve`
     * for the <a href='/angular2/angular2/Injector'><code>Injector</code></a> for performance-sensitive code.
     * 
     * @param `bindings` can be a list of `Type`, <a href='/angular2/angular2/Binding'><code>Binding</code></a>, <a href='/angular2/di/ResolvedBinding'><code>ResolvedBinding</code></a>, or a
     * recursive list of more bindings.
     */
    resolveAndCreateChild(bindings: List<Type | Binding | List<any>>): Injector;

    /**
     * Creates a child injector and loads a new set of <a href='/angular2/di/ResolvedBinding'><code>ResolvedBinding</code></a>s into it.
     * 
     * @param `bindings`: A sparse list of <a href='/angular2/di/ResolvedBinding'><code>ResolvedBinding</code></a>s.
  ...
  class Binding {
    ...
    /**
     * Converts the <a href='/angular2/angular2/Binding'><code>Binding</code></a> into <a href='/angular2/di/ResolvedBinding'><code>ResolvedBinding</code></a>.
     * 
     * <a href='/angular2/angular2/Injector'><code>Injector</code></a> internally only uses <a href='/angular2/di/ResolvedBinding'><code>ResolvedBinding</code></a>, <a href='/angular2/angular2/Binding'><code>Binding</code></a> contains
   ...
   * 
   * This is only relevant for JavaScript. See <a href='/angular2/di/BindingBuilder'><code>BindingBuilder</code></a>.
   * 
   * ## Example
   * 
   * ```javascript
  ...
  class DomRenderer extends  Renderer {
    ...
    setElementAttribute(viewRef: RenderViewRef, elementIndex: number, attributeName: string, attributeValue: string): void;
    setElementClass(viewRef: RenderViewRef, elementIndex: number, className: string, isAdd: boolean): void;
    setElementStyle(viewRef: RenderViewRef, elementIndex: number, styleName: string, styleValue: string): void;
    invokeElementMethod(viewRef: RenderViewRef, elementIndex: number, methodName: string, args: List<any>): void;
  ...
  class Renderer {
     ...
     */
    setElementAttribute(viewRef: RenderViewRef, elementIndex: number, attributeName: string, attributeValue: string);
     ...
     */
    setElementStyle(viewRef: RenderViewRef, elementIndex: number, styleName: string, styleValue: string);

    /**
     * Calls a method on an element.
     */
    invokeElementMethod(viewRef: RenderViewRef, elementIndex: number, methodName: string, args: List<any>);
